...
Over the years I have training and developing Machine Learning algorithms and it didn’t take long before I noticed that I needed to find a way to take my models into production then I delved into the world of MLOps, actually I heard about it first from [Pau Labarta Bajo](https://x.com/paulabartabajo_), in this [X post](https://x.com/paulabartabajo_/status/1704380630547439702?s=20) and it was actually through this PyData [workshop](https://www.youtube.com/watch?v=Jf3259BDMC0) were Jim Dowling, CEO of Hopsworks, talked about building production Machine Learning systems with only python using serverless service, that I got more exposed to MLOps
